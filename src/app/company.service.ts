...
export class CompanyService {
  ...
  private addCompanyUrl = 'http://localhost:8000/add-company/';
  private editCompanyUrl = 'http://localhost:8000/edit-company/';
  private deleteCompanyUrl = 'http://localhost:8000/delete-company/';
