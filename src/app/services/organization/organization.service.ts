...
export class OrganizationService {
  ...
  private organizationsUrl = 'https://us-central1-rm-ds-db.cloudfunctions.net/api/organizations/';
  private detailUrl = 'https://us-central1-rm-ds-db.cloudfunctions.net/api/organization/';
  private addOrganizationUrl = 'https://us-central1-rm-ds-db.cloudfunctions.net/api/add-organization/';
  private editOrganizationUrl = 'https://us-central1-rm-ds-db.cloudfunctions.net/api/edit-organization/';
  private deleteOrganizationUrl = 'https://us-central1-rm-ds-db.cloudfunctions.net/api/delete-organization/';
